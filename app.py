...
def poster_grid(cards, cols=6, key_prefix="grid"):
    ...
    for r in range(rows):
        ...
        for c in range(cols):
            ...
            with colset[c]:
                if poster:
                     base_page_width = 1200
                     col_width = int(base_page_width / cols) - 20 
...
# ==========================================================
    ...
    with left:
        ...
        if data.get("poster_url"):
            st.image(data["poster_url"], width=300)   # or just st.image(data["poster_url"])
    ...
    if data.get("backdrop_url"):
         ...
         st.image(data["backdrop_url"], width=600)   # or just st.image(data["backdrop_url"])
